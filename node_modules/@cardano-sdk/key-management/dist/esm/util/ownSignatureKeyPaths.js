...
const checkStakeCredential = (address, keyHash) => address.stakeKeyDerivationPath && Cardano.RewardAccount.toHash(address.rewardAccount) === keyHash
...
export const ownSignatureKeyPaths = (txBody, knownAddresses, txInKeyPathMap, dRepKeyHash, scripts) => {
