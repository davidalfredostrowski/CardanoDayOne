...
var _InMemoryKeyAgent_instances, _InMemoryKeyAgent_getPassphrase, _InMemoryKeyAgent_rootPrivateKeyEncryption, _InMemoryKeyAgent_decryptRootPrivateKey;
...
const defaultRootPrivateKeyEncryption = { decrypt: emip3_1.emip3decrypt, encrypt: emip3_1.emip3encrypt };
...
class InMemoryKeyAgent extends KeyAgentBase_1.KeyAgentBase {
    constructor({ getPassphrase, ...serializableData }, dependencies) {
        ...
        _InMemoryKeyAgent_rootPrivateKeyEncryption.set(this, void 0);
        __classPrivateFieldSet(this, _InMemoryKeyAgent_getPassphrase, getPassphrase, "f");
        __classPrivateFieldSet(this, _InMemoryKeyAgent_rootPrivateKeyEncryption, dependencies.rootPrivateKeyEncryption ?? defaultRootPrivateKeyEncryption, "f");
    }
    ...
    static async fromBip39MnemonicWords({ chainId, getPassphrase, mnemonicWords, mnemonic2ndFactorPassphrase = '', accountIndex = 0, purpose = types_1.KeyPurpose.STANDARD }, dependencies) {
        ...
        const encryptedRootPrivateKey = await rootPrivateKeyEncryption.encrypt(Buffer.from(rootPrivateKey, 'hex'), passphrase);
    ...
    async signTransaction(txBody, { txInKeyPathMap, knownAddresses, scripts }, { additionalKeyPaths = [] } = {}) {
        ...
        const derivationPaths = (0, util_1.ownSignatureKeyPaths)(body, knownAddresses, txInKeyPathMap, dRepKeyHash, scripts);
...
_InMemoryKeyAgent_getPassphrase = new WeakMap(), _InMemoryKeyAgent_rootPrivateKeyEncryption = new WeakMap(), _InMemoryKeyAgent_instances = new WeakSet(), _InMemoryKeyAgent_decryptRootPrivateKey = async function _InMemoryKeyAgent_decryptRootPrivateKey(noCache) {
    ...
    try {
        decryptedRootKeyBytes = await __classPrivateFieldGet(this, _InMemoryKeyAgent_rootPrivateKeyEncryption, "f").decrypt(new Uint8Array(this.serializableData.encryptedRootPrivateKeyBytes), passphrase);
    }
    catch (error) {
