...
import { CborSet, Credential, Hash } from '../Common/index.js';
import { Certificate } from '../Certificates/index.js';
import { Guards, GuardsKind } from './Guards.js';
...
import { SubTransaction } from '../SubTransaction.js';
...
export class TransactionBody {
    ...
    toCbor() {
        ...
        if (__classPrivateFieldGet(this, _TransactionBody_requiredSigners, "f")?.values() !== undefined && __classPrivateFieldGet(this, _TransactionBody_requiredSigners, "f").size() > 0) {
            ...
            writer.writeInt(14n);
            writer.writeEncodedValue(hexToBytes(__classPrivateFieldGet(this, _TransactionBody_guards, "f").toCbor()));
        }
        ...
        if (__classPrivateFieldGet(this, _TransactionBody_subTransactions, "f") !== undefined && __classPrivateFieldGet(this, _TransactionBody_subTransactions, "f").size() > 0) {
            writer.writeInt(23n);
            writer.writeEncodedValue(hexToBytes(__classPrivateFieldGet(this, _TransactionBody_subTransactions, "f").toCbor()));
        }
        ...
        while (reader.peekState() !== CborReaderState.EndMap) {
            ...
            switch (key) {
                ...
                case 22n:
                    ...
                    break;
                case 23n: {
                    const subTransactions = CborSet.fromCbor(HexBlob.fromBytes(reader.readEncodedValue()), (subTxCbor) => SubTransaction.fromCbor(subTxCbor, options));
                    if (subTransactions.size() === 0)
                        throw new SerializationError(SerializationFailure.InvalidType, 'sub_transactions (transaction body key 23) must be a non-empty set');
                    ...
                    if (subTransactionIds.size !== subTransactions.size())
                        throw new SerializationError(SerializationFailure.InvalidType, 'sub_transactions (transaction body key 23) must not contain duplicate sub transaction ids');
                ...
                case 25n: {
                    ...
                    if (directDeposits.size === 0)
                        throw new SerializationError(SerializationFailure.InvalidType, 'direct_deposits (transaction body key 25) must be a non-empty map');
                ...
                case 26n: {
                    ...
                    if (accountBalanceIntervals.size === 0)
                        throw new SerializationError(SerializationFailure.InvalidType, 'account_balance_intervals (transaction body key 26) must be a non-empty map');
    ...
    static fromCore(coreTransactionBody) {
        ...
        if (coreTransactionBody.guards)
            body.setGuards(Guards.fromCredentials(coreTransactionBody.guards));
    ...
    setGuards(guards) {
        if (guards.kind() === GuardsKind.KeyHashes) {
            __classPrivateFieldSet(this, _TransactionBody_requiredSigners, CborSet.fromCbor(guards.toCbor(), Hash.fromCbor), "f");
            __classPrivateFieldSet(this, _TransactionBody_guards, undefined, "f");
        }
        else {
