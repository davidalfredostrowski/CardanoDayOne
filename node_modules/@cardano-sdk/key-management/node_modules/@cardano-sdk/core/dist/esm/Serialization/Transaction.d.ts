...
import { DeserializationOptions } from './Common/index.js';
...
export declare type TxCBOR = OpaqueString<'TxCbor'> & HexBlob;
export declare type TxBodyCBOR = OpaqueString<'TxBodyCbor'> & HexBlob;
