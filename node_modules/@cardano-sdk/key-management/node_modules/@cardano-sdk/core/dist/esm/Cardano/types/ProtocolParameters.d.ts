...
declare type NewProtocolParamsInDijkstra = {
    maxRefScriptSizePerBlock: number;
    maxRefScriptSizePerTx: number;
    refScriptCostStride: number;
    refScriptCostMultiplier: string;
};
export declare type ProtocolParameters = BabbageProtocolParameters & Partial<NewProtocolParamsInConway> & Partial<NewProtocolParamsInDijkstra>;
