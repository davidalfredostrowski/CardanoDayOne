...
const MAX_MINOR_PROTOCOL_VERSION = 4294967295;
class ProtocolVersion {
    ...
    toCbor() {
        ...
        if (!Number.isInteger(__classPrivateFieldGet(this, _ProtocolVersion_minor, "f")) || __classPrivateFieldGet(this, _ProtocolVersion_minor, "f") < 0 || __classPrivateFieldGet(this, _ProtocolVersion_minor, "f") > MAX_MINOR_PROTOCOL_VERSION)
            throw new util_1.InvalidStateError(`Minor protocol version must be a uint of size 4 (0 to ${MAX_MINOR_PROTOCOL_VERSION}), but got ${__classPrivateFieldGet(this, _ProtocolVersion_minor, "f")}`);
