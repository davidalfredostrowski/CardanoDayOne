...
var _TransactionBody_instances, _TransactionBody_inputs, _TransactionBody_outputs, _TransactionBody_fee, _TransactionBody_ttl, _TransactionBody_certs, _TransactionBody_withdrawals, _TransactionBody_update, _TransactionBody_auxiliaryDataHash, _TransactionBody_validityStartInterval, _TransactionBody_mint, _TransactionBody_scriptDataHash, _TransactionBody_collateral, _TransactionBody_requiredSigners, _TransactionBody_guards, _TransactionBody_networkId, _TransactionBody_collateralReturn, _TransactionBody_totalCollateral, _TransactionBody_referenceInputs, _TransactionBody_votingProcedures, _TransactionBody_proposalProcedures, _TransactionBody_currentTreasuryValue, _TransactionBody_donation, _TransactionBody_directDeposits, _TransactionBody_accountBalanceIntervals, _TransactionBody_subTransactions, _TransactionBody_originalBytes, _TransactionBody_getMapSize;
...
class TransactionBody {
    constructor(inputs, outputs, fee, ttl) {
        ...
        _TransactionBody_guards.set(this, void 0);
        ...
        _TransactionBody_directDeposits.set(this, void 0);
        _TransactionBody_accountBalanceIntervals.set(this, void 0);
        _TransactionBody_subTransactions.set(this, void 0);
    ...
    toCbor() {
        ...
        else if (__classPrivateFieldGet(this, _TransactionBody_guards, "f") !== undefined && __classPrivateFieldGet(this, _TransactionBody_guards, "f").size() > 0) {
            writer.writeInt(14n);
            writer.writeEncodedValue((0, misc_1.hexToBytes)(__classPrivateFieldGet(this, _TransactionBody_guards, "f").toCbor()));
        }
        ...
        if (__classPrivateFieldGet(this, _TransactionBody_subTransactions, "f") !== undefined && __classPrivateFieldGet(this, _TransactionBody_subTransactions, "f").size() > 0) {
            writer.writeInt(23n);
            writer.writeEncodedValue((0, misc_1.hexToBytes)(__classPrivateFieldGet(this, _TransactionBody_subTransactions, "f").toCbor()));
        }
        if (__classPrivateFieldGet(this, _TransactionBody_directDeposits, "f") !== undefined && __classPrivateFieldGet(this, _TransactionBody_directDeposits, "f").size > 0) {
            writer.writeInt(25n);
            const depositsWithAddressBytes = new Map();
            for (const [key, value] of __classPrivateFieldGet(this, _TransactionBody_directDeposits, "f")) {
                const rewardAddress = Address_1.RewardAddress.fromAddress(Address_1.Address.fromBech32(key));
                if (!rewardAddress) {
        ...
        if (__classPrivateFieldGet(this, _TransactionBody_accountBalanceIntervals, "f") !== undefined && __classPrivateFieldGet(this, _TransactionBody_accountBalanceIntervals, "f").size > 0) {
            writer.writeInt(26n);
            const intervalsWithCredentialBytes = new Map();
            for (const [credential, interval] of __classPrivateFieldGet(this, _TransactionBody_accountBalanceIntervals, "f")) {
        ...
        while (reader.peekState() !== CBOR_1.CborReaderState.EndMap) {
            ...
            switch (key) {
                ...
                case 15n:
                    ...
                    break;
                case 16n:
                    body.setCollateralReturn(TransactionOutput_1.TransactionOutput.fromCbor(util_1.HexBlob.fromBytes(reader.readEncodedValue()), options));
                    break;
                case 17n:
                ...
                case 22n:
                    ...
                    break;
                case 23n: {
                    const subTransactions = Common_1.CborSet.fromCbor(util_1.HexBlob.fromBytes(reader.readEncodedValue()), (subTxCbor) => SubTransaction_1.SubTransaction.fromCbor(subTxCbor, options));
                    if (subTransactions.size() === 0)
                        throw new errors_1.SerializationError(errors_1.SerializationFailure.InvalidType, 'sub_transactions (transaction body key 23) must be a non-empty set');
                    ...
                    if (subTransactionIds.size !== subTransactions.size())
                        throw new errors_1.SerializationError(errors_1.SerializationFailure.InvalidType, 'sub_transactions (transaction body key 23) must not contain duplicate sub transaction ids');
                ...
                case 25n: {
                    ...
                    if (directDeposits.size === 0)
                        throw new errors_1.SerializationError(errors_1.SerializationFailure.InvalidType, 'direct_deposits (transaction body key 25) must be a non-empty map');
                ...
                case 26n: {
                    ...
                    if (accountBalanceIntervals.size === 0)
                        throw new errors_1.SerializationError(errors_1.SerializationFailure.InvalidType, 'account_balance_intervals (transaction body key 26) must be a non-empty map');
                    body.setAccountBalanceIntervals(accountBalanceIntervals);
                    break;
                }
                default:
                    if (options?.strict)
                        throw new errors_1.SerializationError(errors_1.SerializationFailure.UnknownField, `Unknown transaction body map key: ${key}`);
                    reader.skipValue();
            }
        }
        reader.readEndMap();
    ...
    toCore() {
        const guardCredentials = __classPrivateFieldGet(this, _TransactionBody_guards, "f")?.credentials();
        ...
        return {
            ...(__classPrivateFieldGet(this, _TransactionBody_accountBalanceIntervals, "f") && {
                accountBalanceIntervals: [...__classPrivateFieldGet(this, _TransactionBody_accountBalanceIntervals, "f")].map(([credential, interval]) => ({
            ...
            ...(__classPrivateFieldGet(this, _TransactionBody_directDeposits, "f") && {
                directDeposits: [...__classPrivateFieldGet(this, _TransactionBody_directDeposits, "f")].map(([stakeAddress, quantity]) => ({ quantity, stakeAddress }))
            }),
            ...
            requiredExtraSignatures: __classPrivateFieldGet(this, _TransactionBody_requiredSigners, "f")?.toCore() ?? (guardKeyHashes && guardKeyHashes.length > 0 ? guardKeyHashes : undefined),
            scriptIntegrityHash: __classPrivateFieldGet(this, _TransactionBody_scriptDataHash, "f"),
            ...(__classPrivateFieldGet(this, _TransactionBody_subTransactions, "f")?.values() && { subTransactions: __classPrivateFieldGet(this, _TransactionBody_subTransactions, "f").toCore() }),
    ...
    static fromCore(coreTransactionBody) {
        ...
        if (coreTransactionBody.guards)
            body.setGuards(Guards_1.Guards.fromCredentials(coreTransactionBody.guards));
        ...
        if (coreTransactionBody.subTransactions)
            body.setSubTransactions(Common_1.CborSet.fromCore(coreTransactionBody.subTransactions, SubTransaction_1.SubTransaction.fromCore));
        return body;
    }
    setInputs(inputs) {
        __classPrivateFieldSet(this, _TransactionBody_inputs, inputs, "f");
    ...
    setRequiredSigners(requiredSigners) {
        ...
        __classPrivateFieldSet(this, _TransactionBody_guards, undefined, "f");
        __classPrivateFieldSet(this, _TransactionBody_originalBytes, undefined, "f");
    }
    requiredSigners() {
    ...
    setGuards(guards) {
        if (guards.kind() === Guards_1.GuardsKind.KeyHashes) {
            __classPrivateFieldSet(this, _TransactionBody_requiredSigners, Common_1.CborSet.fromCbor(guards.toCbor(), Common_1.Hash.fromCbor), "f");
            __classPrivateFieldSet(this, _TransactionBody_guards, undefined, "f");
        }
        else {
            __classPrivateFieldSet(this, _TransactionBody_guards, guards, "f");
            __classPrivateFieldSet(this, _TransactionBody_requiredSigners, undefined, "f");
        }
        __classPrivateFieldSet(this, _TransactionBody_originalBytes, undefined, "f");
    }
    guards() {
        return __classPrivateFieldGet(this, _TransactionBody_guards, "f");
    }
    ...
    setDirectDeposits(directDeposits) {
        __classPrivateFieldSet(this, _TransactionBody_directDeposits, directDeposits, "f");
        __classPrivateFieldSet(this, _TransactionBody_originalBytes, undefined, "f");
    }
    directDeposits() {
        return __classPrivateFieldGet(this, _TransactionBody_directDeposits, "f");
    }
    setAccountBalanceIntervals(accountBalanceIntervals) {
        __classPrivateFieldSet(this, _TransactionBody_accountBalanceIntervals, accountBalanceIntervals, "f");
        __classPrivateFieldSet(this, _TransactionBody_originalBytes, undefined, "f");
    }
    accountBalanceIntervals() {
        return __classPrivateFieldGet(this, _TransactionBody_accountBalanceIntervals, "f");
    }
    setSubTransactions(subTransactions) {
        __classPrivateFieldSet(this, _TransactionBody_subTransactions, subTransactions, "f");
        __classPrivateFieldSet(this, _TransactionBody_originalBytes, undefined, "f");
    }
    subTransactions() {
        return __classPrivateFieldGet(this, _TransactionBody_subTransactions, "f");
    }
    hash() {
    ...
    hasBabbageOutput() {
        if (__classPrivateFieldGet(this, _TransactionBody_outputs, "f").length === 0)
            return false;
        const reader = new CBOR_1.CborReader(__classPrivateFieldGet(this, _TransactionBody_outputs, "f")[0].toCbor());
        return reader.peekState() === CBOR_1.CborReaderState.StartMap;
    }
}
exports.TransactionBody = TransactionBody;
_TransactionBody_inputs = new WeakMap(), _TransactionBody_outputs = new WeakMap(), _TransactionBody_fee = new WeakMap(), _TransactionBody_ttl = new WeakMap(), _TransactionBody_certs = new WeakMap(), _TransactionBody_withdrawals = new WeakMap(), _TransactionBody_update = new WeakMap(), _TransactionBody_auxiliaryDataHash = new WeakMap(), _TransactionBody_validityStartInterval = new WeakMap(), _TransactionBody_mint = new WeakMap(), _TransactionBody_scriptDataHash = new WeakMap(), _TransactionBody_collateral = new WeakMap(), _TransactionBody_requiredSigners = new WeakMap(), _TransactionBody_guards = new WeakMap(), _TransactionBody_networkId = new WeakMap(), _TransactionBody_collateralReturn = new WeakMap(), _TransactionBody_totalCollateral = new WeakMap(), _TransactionBody_referenceInputs = new WeakMap(), _TransactionBody_votingProcedures = new WeakMap(), _TransactionBody_proposalProcedures = new WeakMap(), _TransactionBody_currentTreasuryValue = new WeakMap(), _TransactionBody_donation = new WeakMap(), _TransactionBody_directDeposits = new WeakMap(), _TransactionBody_accountBalanceIntervals = new WeakMap(), _TransactionBody_subTransactions = new WeakMap(), _TransactionBody_originalBytes = new WeakMap(), _TransactionBody_instances = new WeakSet(), _TransactionBody_getMapSize = function _TransactionBody_getMapSize() {
    let mapSize = 0;
    if (__classPrivateFieldGet(this, _TransactionBody_inputs, "f") !== undefined && __classPrivateFieldGet(this, _TransactionBody_inputs, "f").size() > 0)
        ++mapSize;
    if (__classPrivateFieldGet(this, _TransactionBody_outputs, "f") !== undefined)
    ...
    if (__classPrivateFieldGet(this, _TransactionBody_collateral, "f") !== undefined && __classPrivateFieldGet(this, _TransactionBody_collateral, "f").size() > 0)
        ++mapSize;
    if ((__classPrivateFieldGet(this, _TransactionBody_requiredSigners, "f")?.values() !== undefined && __classPrivateFieldGet(this, _TransactionBody_requiredSigners, "f").size() > 0) ||
        (__classPrivateFieldGet(this, _TransactionBody_guards, "f") !== undefined && __classPrivateFieldGet(this, _TransactionBody_guards, "f").size() > 0))
        ++mapSize;
    if (__classPrivateFieldGet(this, _TransactionBody_networkId, "f") !== undefined)
        ++mapSize;
    if (__classPrivateFieldGet(this, _TransactionBody_collateralReturn, "f") !== undefined)
