...
export declare type TransactionId = OpaqueString<'TransactionId'> & Crypto.Hash32ByteBase16;
...
export interface SubTransactionBody extends Omit<TxBody, 'fee' | 'collaterals' | 'collateralReturn' | 'totalCollateral' | 'update' | 'subTransactions'> {
