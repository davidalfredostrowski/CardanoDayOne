...
class Transaction {
    ...
    static fromCbor(cbor, options) {
        ...
        const body = TransactionBody_1.TransactionBody.fromCbor(util_1.HexBlob.fromBytes(bodyBytes), options);
        const witnessSet = TransactionWitnessSet_1.TransactionWitnessSet.fromCbor(util_1.HexBlob.fromBytes(reader.readEncodedValue()), options);
        let isValid = true;
    ...
    static fromCore(tx) {
        ...
        if (typeof tx.isValid !== 'undefined')
            __classPrivateFieldSet(transaction, _Transaction_isValid, tx.isValid, "f");
        return transaction;
    }
    body() {
