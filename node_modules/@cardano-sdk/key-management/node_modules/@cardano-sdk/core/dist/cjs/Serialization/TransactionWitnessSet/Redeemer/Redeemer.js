    ...
    toCore() {
        ...
        switch (__classPrivateFieldGet(this, _Redeemer_tag, "f")) {
            ...
            case RedeemerTag_1.RedeemerTag.Proposing:
                ...
                break;
            case RedeemerTag_1.RedeemerTag.Guarding:
                purpose = Transaction_1.RedeemerPurpose.guarding;
                break;
            default:
    ...
    static fromCore(redeemer) {
        ...
        switch (redeemer.purpose) {
            ...
            case Transaction_1.RedeemerPurpose.propose:
                ...
                break;
            case Transaction_1.RedeemerPurpose.guarding:
                tag = RedeemerTag_1.RedeemerTag.Guarding;
                break;
            default:
