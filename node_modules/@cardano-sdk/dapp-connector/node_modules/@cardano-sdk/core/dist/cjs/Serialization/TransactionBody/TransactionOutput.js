...
class TransactionOutput {
            ...
            while (reader.peekState() !== CBOR_1.CborReaderState.EndMap) {
                ...
                switch (key) {
                    ...
                    case 2n: {
                        ...
                        if (datumKind !== Datum_1.DatumKind.DataHash && datumKind !== Datum_1.DatumKind.InlineData)
                            throw new util_1.InvalidArgumentError('cbor', `Unexpected datum kind ${datumKind}`);
                    ...
                    default:
                        if (options?.strict)
                            throw new errors_1.SerializationError(errors_1.SerializationFailure.UnknownField, `Unknown transaction output map key: ${key}`);
                        reader.skipValue();
                }
            }
            reader.readEndMap();
    ...
    isBabbageOutput() {
        const reader = new CBOR_1.CborReader(this.toCbor());
