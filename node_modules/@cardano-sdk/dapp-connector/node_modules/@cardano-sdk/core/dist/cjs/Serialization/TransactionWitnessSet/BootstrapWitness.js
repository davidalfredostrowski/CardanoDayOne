...
const assertChainCodeSize = (chainCode) => {
    const size = chainCode.length / 2;
    if (size !== CHAIN_CODE_SIZE)
        throw new util_1.InvalidStateError(`chainCode is expected to be ${CHAIN_CODE_SIZE} bytes in size, but got ${size}`);
};
class BootstrapWitness {
    ...
    toCbor() {
        ...
        assertChainCodeSize(__classPrivateFieldGet(this, _BootstrapWitness_chainCode, "f"));
