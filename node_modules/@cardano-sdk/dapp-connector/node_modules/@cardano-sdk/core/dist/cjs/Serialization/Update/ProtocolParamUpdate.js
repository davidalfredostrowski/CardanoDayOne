...
const MAX_WORD32 = 4294967295;
const assertUint32 = (argName, value) => {
    if (!Number.isInteger(value) || value < 0 || value > MAX_WORD32)
        throw new util_1.InvalidArgumentError(argName, `Expected an integer between 0 and ${MAX_WORD32}, but got ${value}`);
};
const assertPositiveWord32 = (argName, value) => {
    if (!Number.isInteger(value) || value < 1 || value > MAX_WORD32)
        throw new util_1.InvalidArgumentError(argName, `Expected an integer between 1 and ${MAX_WORD32}, but got ${value}`);
};
const assertPositiveInterval = (argName, value) => {
    if (value.numerator() < 1n || value.denominator() < 1n)
        throw new util_1.InvalidArgumentError(argName, `Expected a positive interval, but got ${value.numerator()}/${value.denominator()}`);
};
class ProtocolParamUpdate {
    constructor() {
        ...
        _ProtocolParamUpdate_maxRefScriptSizePerBlock.set(this, void 0);
        _ProtocolParamUpdate_maxRefScriptSizePerTx.set(this, void 0);
        _ProtocolParamUpdate_refScriptCostStride.set(this, void 0);
        _ProtocolParamUpdate_refScriptCostMultiplier.set(this, void 0);
    ...
    toCbor() {
        ...
        if (__classPrivateFieldGet(this, _ProtocolParamUpdate_maxRefScriptSizePerBlock, "f") !== undefined) {
            assertUint32('maxRefScriptSizePerBlock', __classPrivateFieldGet(this, _ProtocolParamUpdate_maxRefScriptSizePerBlock, "f"));
            writer.writeInt(34n);
            writer.writeInt(__classPrivateFieldGet(this, _ProtocolParamUpdate_maxRefScriptSizePerBlock, "f"));
        }
        if (__classPrivateFieldGet(this, _ProtocolParamUpdate_maxRefScriptSizePerTx, "f") !== undefined) {
            assertUint32('maxRefScriptSizePerTx', __classPrivateFieldGet(this, _ProtocolParamUpdate_maxRefScriptSizePerTx, "f"));
            writer.writeInt(35n);
            writer.writeInt(__classPrivateFieldGet(this, _ProtocolParamUpdate_maxRefScriptSizePerTx, "f"));
        }
        if (__classPrivateFieldGet(this, _ProtocolParamUpdate_refScriptCostStride, "f") !== undefined) {
            assertPositiveWord32('refScriptCostStride', __classPrivateFieldGet(this, _ProtocolParamUpdate_refScriptCostStride, "f"));
            writer.writeInt(36n);
            writer.writeInt(__classPrivateFieldGet(this, _ProtocolParamUpdate_refScriptCostStride, "f"));
        }
        if (__classPrivateFieldGet(this, _ProtocolParamUpdate_refScriptCostMultiplier, "f") !== undefined) {
            assertPositiveInterval('refScriptCostMultiplier', __classPrivateFieldGet(this, _ProtocolParamUpdate_refScriptCostMultiplier, "f"));
            writer.writeInt(37n);
            writer.writeEncodedValue(Buffer.from(__classPrivateFieldGet(this, _ProtocolParamUpdate_refScriptCostMultiplier, "f").toCbor(), 'hex'));
        }
        ...
        while (reader.peekState() !== CBOR_1.CborReaderState.EndMap) {
            ...
            switch (key) {
                ...
                case 33n:
                    ...
                    break;
                case 34n:
                    __classPrivateFieldSet(params, _ProtocolParamUpdate_maxRefScriptSizePerBlock, Number(reader.readInt()), "f");
                    break;
                case 35n:
                    __classPrivateFieldSet(params, _ProtocolParamUpdate_maxRefScriptSizePerTx, Number(reader.readInt()), "f");
                    break;
                case 36n:
                    __classPrivateFieldSet(params, _ProtocolParamUpdate_refScriptCostStride, Number(reader.readInt()), "f");
                    break;
                case 37n:
                    __classPrivateFieldSet(params, _ProtocolParamUpdate_refScriptCostMultiplier, Common_1.UnitInterval.fromCbor(util_1.HexBlob.fromBytes(reader.readEncodedValue())), "f");
                    break;
            }
        }
        reader.readEndMap();
    ...
    toCore() {
        const protocolParametersUpdate = {
            ...
            maxRefScriptSizePerBlock: __classPrivateFieldGet(this, _ProtocolParamUpdate_maxRefScriptSizePerBlock, "f"),
            maxRefScriptSizePerTx: __classPrivateFieldGet(this, _ProtocolParamUpdate_maxRefScriptSizePerTx, "f"),
            ...
            refScriptCostMultiplier: __classPrivateFieldGet(this, _ProtocolParamUpdate_refScriptCostMultiplier, "f")
                ? __classPrivateFieldGet(this, _ProtocolParamUpdate_refScriptCostMultiplier, "f").toFloat().toString()
                : undefined,
            refScriptCostStride: __classPrivateFieldGet(this, _ProtocolParamUpdate_refScriptCostStride, "f"),
    ...
    static fromCore(parametersUpdate) {
        ...
        __classPrivateFieldSet(params, _ProtocolParamUpdate_minFeeRefScriptCostPerByte, parametersUpdate.minFeeRefScriptCostPerByte
            ...
            : undefined, "f");
        __classPrivateFieldSet(params, _ProtocolParamUpdate_maxRefScriptSizePerBlock, parametersUpdate.maxRefScriptSizePerBlock, "f");
        __classPrivateFieldSet(params, _ProtocolParamUpdate_maxRefScriptSizePerTx, parametersUpdate.maxRefScriptSizePerTx, "f");
        __classPrivateFieldSet(params, _ProtocolParamUpdate_refScriptCostStride, parametersUpdate.refScriptCostStride, "f");
        __classPrivateFieldSet(params, _ProtocolParamUpdate_refScriptCostMultiplier, parametersUpdate.refScriptCostMultiplier
            ? Common_1.UnitInterval.fromFloat(Number(parametersUpdate.refScriptCostMultiplier))
            : undefined, "f");
