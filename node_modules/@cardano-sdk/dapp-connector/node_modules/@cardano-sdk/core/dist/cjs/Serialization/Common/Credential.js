...
exports.Credential = exports.readCredentialType = void 0;
const CBOR_1 = require("../CBOR");
const Address_1 = require("../../Cardano/Address/Address");
const util_1 = require("@cardano-sdk/util");
const misc_1 = require("../../util/misc");
const CREDENTIAL_ARRAY_SIZE = 2;
const readCredentialType = (reader) => {
    const type = Number(reader.readInt());
    if (type !== Address_1.CredentialType.KeyHash && type !== Address_1.CredentialType.ScriptHash)
        throw new util_1.InvalidStateError(`Unexpected credential type value: ${type}`);
    return type;
};
exports.readCredentialType = readCredentialType;
class Credential {
    constructor(value) {
    ...
    static fromCbor(cbor) {
        ...
        const type = (0, exports.readCredentialType)(reader);
