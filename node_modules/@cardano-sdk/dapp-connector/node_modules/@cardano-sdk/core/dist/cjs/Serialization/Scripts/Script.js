...
var _Script_nativeScript, _Script_plutusV1, _Script_plutusV2, _Script_plutusV3, _Script_plutusV4, _Script_language, _Script_originalBytes;
...
class Script {
    constructor() {
        ...
        _Script_plutusV4.set(this, void 0);
    ...
    toCbor() {
        ...
        switch (__classPrivateFieldGet(this, _Script_language, "f")) {
            ...
            case ScriptLanguage_1.ScriptLanguage.PlutusV3:
                ...
                break;
            case ScriptLanguage_1.ScriptLanguage.PlutusV4:
                cbor = __classPrivateFieldGet(this, _Script_plutusV4, "f").toCbor();
                break;
            default:
    ...
    static fromCbor(cbor) {
        ...
        switch (language) {
            ...
            case ScriptLanguage_1.ScriptLanguage.PlutusV3:
                ...
                break;
            case ScriptLanguage_1.ScriptLanguage.PlutusV4:
                script = Script.newPlutusV4Script(PlutusScript_1.PlutusV4Script.fromCbor(innerScript));
                break;
            default:
    ...
    toCore() {
        ...
        switch (__classPrivateFieldGet(this, _Script_language, "f")) {
            ...
            case ScriptLanguage_1.ScriptLanguage.PlutusV3:
                ...
                break;
            case ScriptLanguage_1.ScriptLanguage.PlutusV4:
                core = __classPrivateFieldGet(this, _Script_plutusV4, "f").toCore();
                break;
            default:
        ...
        if ((0, Script_1.isNativeScript)(coreScript)) {
            ...
            switch (coreScript.version) {
                ...
                case Script_1.PlutusLanguageVersion.V3:
                    ...
                    break;
                case Script_1.PlutusLanguageVersion.V4:
                    script = Script.newPlutusV4Script(PlutusScript_1.PlutusV4Script.fromCore(coreScript));
                    break;
                default:
    ...
    static newPlutusV4Script(plutusV4Script) {
        const script = new Script();
        __classPrivateFieldSet(script, _Script_plutusV4, plutusV4Script, "f");
        __classPrivateFieldSet(script, _Script_language, ScriptLanguage_1.ScriptLanguage.PlutusV4, "f");
        return script;
    }
    asNative() {
    ...
    asPlutusV4() {
        return __classPrivateFieldGet(this, _Script_plutusV4, "f");
    }
    hash() {
        let hash;
        switch (__classPrivateFieldGet(this, _Script_language, "f")) {
            ...
            case ScriptLanguage_1.ScriptLanguage.PlutusV3:
                ...
                break;
            case ScriptLanguage_1.ScriptLanguage.PlutusV4:
                hash = __classPrivateFieldGet(this, _Script_plutusV4, "f").hash();
                break;
            default:
...
_Script_nativeScript = new WeakMap(), _Script_plutusV1 = new WeakMap(), _Script_plutusV2 = new WeakMap(), _Script_plutusV3 = new WeakMap(), _Script_plutusV4 = new WeakMap(), _Script_language = new WeakMap(), _Script_originalBytes = new WeakMap();
