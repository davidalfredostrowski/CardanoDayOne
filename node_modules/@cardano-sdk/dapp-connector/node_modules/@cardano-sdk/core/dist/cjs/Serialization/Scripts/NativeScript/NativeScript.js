...
var _NativeScript_scriptAll, _NativeScript_scriptAny, _NativeScript_scripNOfK, _NativeScript_scriptPubKey, _NativeScript_timelockExpiry, _NativeScript_timelockStart, _NativeScript_requireGuard, _NativeScript_kind, _NativeScript_originalBytes;
...
const RequireGuard_1 = require("./RequireGuard");
...
class NativeScript {
    constructor() {
        ...
        _NativeScript_requireGuard.set(this, void 0);
    ...
    toCbor() {
        ...
        switch (__classPrivateFieldGet(this, _NativeScript_kind, "f")) {
            ...
            case Script_1.NativeScriptKind.RequireTimeBefore:
                ...
                break;
            case Script_1.NativeScriptKind.RequireGuard:
                cbor = __classPrivateFieldGet(this, _NativeScript_requireGuard, "f").toCbor();
                break;
            default:
    ...
    static fromCbor(cbor) {
        ...
        switch (kind) {
            ...
            case Script_1.NativeScriptKind.RequireTimeBefore:
                ...
                break;
            case Script_1.NativeScriptKind.RequireGuard:
                nativeScript = NativeScript.newRequireGuard(RequireGuard_1.RequireGuard.fromCbor(cbor));
                break;
            default:
    ...
    toCore() {
        ...
        switch (__classPrivateFieldGet(this, _NativeScript_kind, "f")) {
            ...
            case Script_1.NativeScriptKind.RequireTimeBefore:
                ...
                break;
            case Script_1.NativeScriptKind.RequireGuard:
                core = __classPrivateFieldGet(this, _NativeScript_requireGuard, "f").toCore();
                break;
            default:
                throw new util_1.InvalidStateError(`Unexpected kind value: ${__classPrivateFieldGet(this, _NativeScript_kind, "f")}`);
        }
    ...
    static fromCore(script) {
        ...
        switch (script.kind) {
            ...
            case Script_1.NativeScriptKind.RequireTimeBefore:
                ...
                break;
            case Script_1.NativeScriptKind.RequireGuard:
                nativeScript = NativeScript.newRequireGuard(RequireGuard_1.RequireGuard.fromCore(script));
                break;
            default:
    ...
    static newRequireGuard(requireGuard) {
        const script = new NativeScript();
        __classPrivateFieldSet(script, _NativeScript_requireGuard, requireGuard, "f");
        __classPrivateFieldSet(script, _NativeScript_kind, Script_1.NativeScriptKind.RequireGuard, "f");
        return script;
    }
    asScriptPubkey() {
    ...
    asRequireGuard() {
        return __classPrivateFieldGet(this, _NativeScript_requireGuard, "f");
    }
}
exports.NativeScript = NativeScript;
_NativeScript_scriptAll = new WeakMap(), _NativeScript_scriptAny = new WeakMap(), _NativeScript_scripNOfK = new WeakMap(), _NativeScript_scriptPubKey = new WeakMap(), _NativeScript_timelockExpiry = new WeakMap(), _NativeScript_timelockStart = new WeakMap(), _NativeScript_requireGuard = new WeakMap(), _NativeScript_kind = new WeakMap(), _NativeScript_originalBytes = new WeakMap();
