...
var _AuxiliaryData_instances, _a, _AuxiliaryData_metadata, _AuxiliaryData_nativeScripts, _AuxiliaryData_plutusV1Scripts, _AuxiliaryData_plutusV2Scripts, _AuxiliaryData_plutusV3Scripts, _AuxiliaryData_plutusV4Scripts, _AuxiliaryData_originalBytes, _AuxiliaryData_getMapSize, _AuxiliaryData_getCoreScripts, _AuxiliaryData_getCddlScripts;
...
class AuxiliaryData {
    constructor() {
        ...
        _AuxiliaryData_plutusV4Scripts.set(this, void 0);
    ...
    toCbor() {
        ...
        if (elementsSize === 1 && __classPrivateFieldGet(this, _AuxiliaryData_metadata, "f") !== undefined && __classPrivateFieldGet(this, _AuxiliaryData_metadata, "f").metadata().size > 0) {
            ...
            if (__classPrivateFieldGet(this, _AuxiliaryData_plutusV4Scripts, "f") !== undefined && __classPrivateFieldGet(this, _AuxiliaryData_plutusV4Scripts, "f").length > 0) {
                writer.writeInt(5n);
                writer.writeStartArray(__classPrivateFieldGet(this, _AuxiliaryData_plutusV4Scripts, "f").length);
                for (const script of __classPrivateFieldGet(this, _AuxiliaryData_plutusV4Scripts, "f")) {
                    writer.writeEncodedValue((0, misc_1.hexToBytes)(script.toCbor()));
                }
            }
        }
        ...
        if (peekState === CBOR_1.CborReaderState.StartMap) {
            ...
            while (reader.peekState() !== CBOR_1.CborReaderState.EndMap) {
                ...
                switch (key) {
                    ...
                    case 5n: {
                        auxData.setPlutusV4Scripts(new Array());
                        reader.readStartArray();
                        while (reader.peekState() !== CBOR_1.CborReaderState.EndArray) {
                            auxData.plutusV4Scripts().push(Scripts_1.PlutusV4Script.fromCbor(util_1.HexBlob.fromBytes(reader.readEncodedValue())));
                        }
                        reader.readEndArray();
                        break;
                    }
    ...
    static fromCore(auxData) {
        ...
        if (auxData.scripts) {
            ...
            if (scripts.plutusV4)
                result.setPlutusV4Scripts(scripts.plutusV4);
        }
        return result;
    }
    metadata() {
    ...
    plutusV4Scripts() {
        return __classPrivateFieldGet(this, _AuxiliaryData_plutusV4Scripts, "f");
    }
    setPlutusV4Scripts(plutusV4Scripts) {
        __classPrivateFieldSet(this, _AuxiliaryData_plutusV4Scripts, plutusV4Scripts, "f");
        __classPrivateFieldSet(this, _AuxiliaryData_originalBytes, undefined, "f");
    }
}
exports.AuxiliaryData = AuxiliaryData;
_a = AuxiliaryData, _AuxiliaryData_metadata = new WeakMap(), _AuxiliaryData_nativeScripts = new WeakMap(), _AuxiliaryData_plutusV1Scripts = new WeakMap(), _AuxiliaryData_plutusV2Scripts = new WeakMap(), _AuxiliaryData_plutusV3Scripts = new WeakMap(), _AuxiliaryData_plutusV4Scripts = new WeakMap(), _AuxiliaryData_originalBytes = new WeakMap(), _AuxiliaryData_instances = new WeakSet(), _AuxiliaryData_getMapSize = function _AuxiliaryData_getMapSize() {
    let mapSize = 0;
    if (__classPrivateFieldGet(this, _AuxiliaryData_metadata, "f") !== undefined && __classPrivateFieldGet(this, _AuxiliaryData_metadata, "f").metadata().size > 0)
        ++mapSize;
    if (__classPrivateFieldGet(this, _AuxiliaryData_nativeScripts, "f") !== undefined && __classPrivateFieldGet(this, _AuxiliaryData_nativeScripts, "f").length > 0)
    ...
    const plutusV4 = __classPrivateFieldGet(this, _AuxiliaryData_plutusV4Scripts, "f") ? __classPrivateFieldGet(this, _AuxiliaryData_plutusV4Scripts, "f").map((script) => script.toCore()) : [];
    ...
    for (const script of scripts) {
        switch (script.__type) {
            ...
            case Script_1.ScriptType.Plutus:
                ...
                else if (script.version === Script_1.PlutusLanguageVersion.V4) {
                    if (!result.plutusV4)
                        result.plutusV4 = new Array();
                    result.plutusV4.push(Scripts_1.PlutusV4Script.fromCore(script));
                }
                break;
            default:
