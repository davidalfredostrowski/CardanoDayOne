...
const assertPositiveInterval = (argName, value) => {
    if (value.numerator() < 1n || value.denominator() < 1n)
        throw new InvalidArgumentError(argName, `Expected a positive interval, but got ${value.numerator()}/${value.denominator()}`);
};
        ...
        while (reader.peekState() !== CborReaderState.EndMap) {
            ...
            switch (key) {
                ...
                case 36n:
                    ...
                    break;
                case 37n:
                    __classPrivateFieldSet(params, _ProtocolParamUpdate_refScriptCostMultiplier, UnitInterval.fromCbor(HexBlob.fromBytes(reader.readEncodedValue())), "f");
                    break;
            }
        }
        reader.readEndMap();
